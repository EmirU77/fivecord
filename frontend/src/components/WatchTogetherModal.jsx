...
export default function WatchTogetherModal({ isOpen, onClose, onStart }) {
  ...
  const handleStartYouTube = (e) => {
    ...
    if (id) {
      ...
      alert('Lütfen geçerli bir YouTube video linki yapıştırın.');
    }
  };
  ...
  return (
    ...
    >
      <div 
        ...
        className="w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden border border-[#3f4147] flex flex-col"
      ...
      >
        ...
        <div className="p-6 border-b border-[#232428]" style={{ backgroundColor: '#2b2d31' }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#f23f43]/15 flex items-center justify-center text-[#f23f43] shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-[#949ba4] mt-0.5">
                  Videoları odadaki arkadaşlarınla aynı salisede gecikmesiz izle!
                </p>
              </div>
            </div>
            <button 
        ...
        <div className="p-6 space-y-5" style={{ backgroundColor: '#313338' }}>
          ...
          <div>
            <div className="text-xs font-bold uppercase tracking-wider text-[#949ba4] mb-2.5">
              Veya Popüler Hazır Videolardan Seç
            </div>
        ...
        <div className="px-6 py-3 border-t border-[#232428] text-[11px] text-[#949ba4] flex items-center justify-between" style={{ backgroundColor: '#2b2d31' }}>
          <span>⚡ Tüm odadaki bilgisayarlar videoyu aynı salisede senkronize izler.</span>
          <button 
            onClick={onClose}
